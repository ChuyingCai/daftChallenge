...
# Nodes spaced apart so ellipses and arrows are clearly visible
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Acid node (left) — muted styling to signal incorrect theory
pgm.add_node("acid", "Acid", 0.8, 1, aspect=2.2, scale=1.1,
             plot_params={
                 "facecolor": "#b8d4e8",
                 "edgecolor": "#2e6a9e",
                 "linewidth": 2,
...
# Bacteria in Food node (middle)
pgm.add_node("bacteria_in_food", "Bacteria in Food", 3.5, 1, aspect=2.8, scale=1.4,
             plot_params={
                 "facecolor": "#e8e4dc",
                 "edgecolor": "#8a857c",
                 "linewidth": 2,
...
# Scurvy node (right)
pgm.add_node("scurvy", "Scurvy", 6.6, 1, aspect=2.2, scale=1.5,
             plot_params={
                 "facecolor": "#f0d8d8",
                 "edgecolor": "#8b3a3a",
                 "linewidth": 2,
...
pgm.render()
plt.title("⚠️ Updated Bacterial Theory (Late 19th Century) — Misguided Belief", fontsize=12, pad=10);
```
...
pgm.add_node("vitamin_c", "Vitamin C", 0.8, 1, aspect=2.2, scale=1.1,
             plot_params={
                 "facecolor": "#b8e8b8",
                 "edgecolor": "#2e7e2e",
                 "linewidth": 2,
...
# Collagen Synthesis (middle)
pgm.add_node("collagen_synthesis", "Collagen Synthesis", 3.5, 1, aspect=2.8, scale=1.4,
             plot_params={
                 "facecolor": "#e8e4dc",
                 "edgecolor": "#8a857c",
                 "linewidth": 2,
...
pgm.render()
plt.title("☑️Simplified Modern Understanding (1930s onwards)-Complete and Correct", fontsize=12, pad=10);
```
